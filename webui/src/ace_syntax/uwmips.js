      ...
      start: [
          {
            ...
            regex: '\\b(?:add|sub|mult|multu|div|divu|mfhi|mflo|lis|lw|sw|slt|sltu|beq|bne|jr|jalr|addi|j|jal)\\b',
            comment: 'ok actually these are instructions, but one also could call them functions...'
          }, {
