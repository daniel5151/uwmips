    ...
    pub fn from_u32(raw: u32) -> Instr {
        match raw >> (24 + 2) {
            ...
            0 => {
                ...
                let op = match R::from_u8((raw & 0b_1111_1111) as u8) {
                    Some(op) => op,
            ...
            op if op >> 2 == 0 => {
                ...
                let op = match J::from_u8(op as u8) {
                    Some(op) => op,
                    None => return Instr::Inval(raw),
                };
            ...
            op => {
                ...
                let op = match I::from_u8(op as u8) {
                    Some(op) => op,
                    None => return Instr::Inval(raw),
                };
